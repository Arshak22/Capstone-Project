...
export default function HeroVillianSection() {
    const charachters = [
        ...
        },
        {
            ...
            name: SpiderMan_Logo,
            BG: SpiderMan_BG,
            description: "Spider-Man is a beloved superhero known for his superhuman strength and spider-like abilities. He uses his powers to protect the citizens of New York City from dangerous criminals and villains. With his wits and agility, he fights to keep the city safe while also navigating the challenges of being a teenage high school student. Spider-Man's movies are filled with action, humor, and heart, making them a thrilling and entertaining watch for both fans of the comics and newcomers to the franchise. Don't miss your chance to see the web-slinging hero in action!"
        },
        {
            id: "Homelender",
            img: Homelender,
