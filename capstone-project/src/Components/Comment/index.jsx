    ...
    return (
        <div className="movieComment">
            ...
            <div className="movieCommentBody">
                <h1>{props.name}</h1>
                <h4>{editedAt}</h4>
                {props.comment ? <textarea onChange={handleUpdatedComment} name="movieComment" className="movieCommentText" id={props.commentID} rows="4" readOnly>{props.comment}</textarea>: null}
